...
def imageSegmentationGenerator( images_path , segs_path ,  n_classes, img_size ):
	...
	images.sort()
	segmentations  = glob.glob( images_path + "*.JPG"  ) +  glob.glob( segs_path + "*.jpg"  ) + glob.glob( segs_path + "*.png"  ) +  glob.glob( segs_path + "*.jpeg"  )
	segmentations.sort()
...
imageSegmentationGenerator(args.images ,  args.annotations  ,  args.n_classes , args.img_size  ) 
